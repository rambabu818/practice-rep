										...
										<table class="col3_one" width="380" border="0" align="right" cellpadding="0" cellspacing="0">
											...
											<tr align="left" valign="top">
												<td style="font-family: 'Lato', sans-serif; font-size:14px; color:#fff; line-height:24px; font-weight: 300;">
													Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur convallis maximus mollis. Aenean purus magna, dignissim in aliquam quis, ullamcorper a dui. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae.
												</td>
											</tr>
											...
											<tr>
												<td align="center">
													<table width="100" border="0" align="center" cellpadding="0" cellspacing="0" style="border: 2px solid #fbb016;">
														<tbody><tr>
															<td width="10"></td>
															<td height="30" align="center" style="font-family: 'Lato', sans-serif; font-size:14px; font-weight: 300; color:#333;">
